        ...
        <div class="flex justify-between h-16">
            <div class="flex space-x-8 items-center">
                ...
                <div class="flex space-x-6 h-full">
                    ...
                    <a href="{{ route('backorder.manage') }}" 
                       class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium transition {{ request()->routeIs('backorder.manage') ? 'border-gray-900 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                        Backorder
                    </a>
                </div>
            </div>
